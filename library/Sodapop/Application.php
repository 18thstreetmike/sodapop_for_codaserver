...
class Sodapop_Application {
	...
	public function __construct($environment, $config) {
		...
		if (isset($_SESSION['user'])) {
			...
			$_SESSION['user'] = call_user_func(array($databaseClass, 'getUser'), $this->config['model.database.hostname'], $this->config['model.database.port'], $this->config['model.database.public_user'], $this->config['model.database.public_password'], $this->config['model.database.schema'], $environment, null, $this->availableModels);
			$this->user = $_SESSION['user'];
		}
